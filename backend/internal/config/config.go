...
func LoadServerConfig() model.ServerConfig {
	return model.ServerConfig{
		...
		YouComAPIKey:                   getEnv("YDC_API_KEY", ""),
		YouComSearchMaxResults:         getEnvAsInt("YOUCOM_SEARCH_MAX_RESULTS", 5),
		YouComTimeoutSeconds:           getEnvAsInt("YOUCOM_TIMEOUT_SECONDS", 10),
