...
func LoadServerConfig() model.ServerConfig {
	...
	return model.ServerConfig{
		...
		APIRequestsPerMinute:           getEnvAsInt("API_REQUESTS_PER_MINUTE", 120),
		APIMaxConcurrentRequests:       getEnvAsInt("API_MAX_CONCURRENT_REQUESTS", 16),
		ChatMaxConcurrentRequests:      getEnvAsInt("CHAT_MAX_CONCURRENT_REQUESTS", 4),
		IndexMaxConcurrentRequests:     getEnvAsInt("INDEX_MAX_CONCURRENT_REQUESTS", 2),
		EvalMaxConcurrentRequests:      getEnvAsInt("EVAL_MAX_CONCURRENT_REQUESTS", 1),
		UploadMaxConcurrentRequests:    getEnvAsInt("UPLOAD_MAX_CONCURRENT_REQUESTS", 4),
		ModelTestMaxConcurrentRequests: getEnvAsInt("MODEL_TEST_MAX_CONCURRENT_REQUESTS", 2),
